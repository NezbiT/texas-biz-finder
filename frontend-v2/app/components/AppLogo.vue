<!-- Logo animado de TX BizFinder: lupa con "TX" dentro, anillo que
     escanea girando, mango con gradiente cobre y "ping" de hallazgo.
     Todo es SVG + CSS (sin imágenes); respeta prefers-reduced-motion. -->
<script setup lang="ts">
import { useId } from "vue";   // id único por instancia (los gradientes SVG lo necesitan)
...
// useId genera ":r1:" — se limpian los dos puntos para usarlo en ids de SVG
const uid = useId().replace(/:/g, "");

// Tres tamaños del logo (sm en header compacto, md normal, lg hero)
const sizes = {
  sm: "logo-wrap--sm",
  md: "logo-wrap--md",
  lg: "logo-wrap--lg",
...
/* flotación suave arriba/abajo del logo completo */
...
/* brillo pulsante del cristal de la lupa */
@keyframes lens-glow {
  0%,
  100% {
...
/* el anillo punteado gira como radar escaneando */
@keyframes scan-spin {
  from {
...
/* las letras TX laten sutilmente */
@keyframes tx-pop {
  0%,
  100% {
    opacity: 1;
...
/* el mango de la lupa se inclina levemente */
...
/* ping expansivo en el centro (negocio encontrado) */
...
/* el borde del cuadro brilla en ciclos */
